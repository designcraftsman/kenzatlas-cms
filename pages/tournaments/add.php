      ...
      <div class="container-fluid m-0 p-0 ">
        ...
        <form class="p-3 ">
            <div class="row mb-3">
                ...
                <div class="col">
                    <label for="sport" class="mb-3">Sport</label>
            ...
            <div class="row mb-5">
                <div class="col">
                    <label for="description" class="mb-3">Heure</label>
                    <input type="time"   class="form-control"  >
                </div>
                <div class="col">
                    <label for="description" class="mb-3">lieu</label>
                    <input type="text"   class="form-control"  >
                </div>
            </div>
            <button type="submit" class=" btn btn-success  fw-bold">Enregistrer tournoi</button>
         </form>
        </main>
        </div>

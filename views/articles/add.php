        ...
        <form class="p-3 ">
            <div class="row mb-5 align-items-center ">
                ...
                <div class="col">
                    ...
                    <input type="text" name="coach" class="form-control mb-3"  >
                    <label for="sport" class="mb-3">Catégorie</label>
                    <select class="form-select m-0" aria-label="sport">
                        <option selected value="0">Beauté</option>
            ...
            <div class="col  mb-3">
                ...
                <textarea name="contenu" class="w-100  form-control" rows="10" ></textarea>
            </div>
            <a type="button" class="btn btn-primary  p-2 text-white fw-bold"data-bs-toggle="modal" data-bs-target="#exampleModal" ><i class="fa-solid fa-pen"></i> Ajouter l'article</a>
         </form>
        </main>
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="#" type="button" class="btn btn-danger">Enregistrer</a>
                                </div>
                                </div>
                 </div>
            </div>
